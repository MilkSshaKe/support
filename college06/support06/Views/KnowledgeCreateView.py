...
class KnowledgeCreateView(Toplevel):
    """
    ...
    def _build_ui(self) -> None:
        ...
        btn_create.grid(row=2, column=1, sticky="ew", padx=10, pady=(15, 10))

        btn_back = ttk.Button(self, text="Назад", command=self.destroy)
        btn_back.grid(row=2, column=2, sticky="ew", padx=10, pady=(15, 10))
    ...
    def on_create(self) -> None:
        ...
        ok, result = KnowledgeController.create_Knowledge(
            title=title,
