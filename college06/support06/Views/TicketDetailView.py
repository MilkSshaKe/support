...
from Controllers import TicketController, CommentController, KnowledgeController
from Models.Users import Users
from Models.Role import Role
from Models.Ticket import Ticket

from Views.KnowledgeCreateView import KnowledgeCreateView
...
class TicketDetailView(Toplevel):
    ...
    def _build_ui(self) -> None:
        ...
        ''' Перестала работать, отключил все что мешало работе
        ...
        btn_Knowledge = ttk.Button(bottom_frame, text="Создать статью", command=self.on_create_Knowledge)
        btn_Knowledge.pack(side="left", padx=5)
    ...
    def on_create_Knowledge(self) -> None:
        KnowledgeCreateView(self, self.ticket, self.current_user)
